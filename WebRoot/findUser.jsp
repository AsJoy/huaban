	                ...
	                <li>
	                    <div class="adduser">
	                        <div class="userCommon">
	                        	<span class="col-md-1 col-sm-2" style="text-align:center">序号</span>
	                            <span class="col-md-2 col-sm-3" style="text-align: center;">成员头像</span>
	                            <span class="col-md-3 col-sm-3 textoverflow">成员昵称</span>
	                            <span class="col-md-6 col-sm-4 textoverflow">座右铭</span>
	                        </div>
                        </div>
	                </li>
	               	<s:iterator value="#pager.objs" var="user" status="st">
	               		<li>
		                    <div class="adduser">
		                        <div class="userCommon">
	                        		 <a style="display: inline-block; width: 100%;height: 100%" href="<%=path %>/Picture/commonUserPicture.action?uid=<s:property value="#user.id"/>">
		                        		<span class="col-md-1 col-sm-2" style="text-align:center"><s:property value="#st.index+1"/></span>
			                            <span class=" col-md-2 col-sm-3" style="text-align: center;">
			                            	 <label class="userselfpic"><img src='${pager.url }<s:property value="#user.selfpic"/>'></label> 
			                            </span>
			                            <span class="col-md-3 col-sm-3 textoverflow"><s:property value="#user.nickname"/> </span>
			                            <span class="col-md-5 col-sm-4 textoverflow"><s:property value="#user.motto"/></span>
		                       		 </a> 	
		                        </div>
		                    </div>
	                	</li>	
