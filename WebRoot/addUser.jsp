...
<body>
    ...
    <article class="container">
        <div class="span1 col-md-10 col-md-offset-1">
            <p class="userCommon caption"><strong>注册个人信息</strong></p>
             <form class="form-horizontal" action="<%=path %>/User/userAction.action" method="post" id="adduser" enctype="multipart/form-data">
	            <ul class="col-md-11 userNav">
	                    ...
	                    <div class="adduser">
	                        ...
	                        <div class="adduserdetail">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-4">
	                                        <input type="text" name="username" class="form-control" placeholder="3-16位账号" pattern="^[a-z0-9_-]{3,16}$" required  />
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <label class="control-label col-md-2">登录密码：</label>
	                                    <div class="col-md-4">
	                                        <input type="password" name="password" class="form-control" pattern="^[a-z0-9_-]{6,18}$" required placeholder="6位或以上密码" />
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <label class="control-label col-md-2">昵称：</label>
	                                    <div class="col-md-4">
	                                        <input type="text" name="nickname" class="form-control" placeholder="用户昵称" required/>
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                                    <label class="control-label col-md-2">签名：</label>
	                                    <div class="col-md-4">
	                                        <input type="text" name="motto" class="form-control" placeholder="座右铭" required/>
	                                    </div>
	                                </div>
	                        </div>
	                    </div>
	             ...
	             <button type="submit" class="btn btn-danger col-md-offset-4" >注册用户</button>
